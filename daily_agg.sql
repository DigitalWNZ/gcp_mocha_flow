...
if (event_name='battle_power_change' and event_params.key='change_power',event_params.value.int_value,null) as battle_power_change__change_power,
...
if (event_name='donate' and event_params.key='tot_times',event_params.value.int_value,null) as donate__tot_times,
...
if (event_name='lord_equipment_gem_power' and event_params.key='change_power',event_params.value.int_value,null) as lord_equipment_gem_power__change_power,
if (event_name='IapPaymentSuccess',1,0) as IapPaymentSuccess__count,
if (event_name='survivor_camp',1,0) as survivor_camp__count,
if (event_name='hide_troop' and event_params.key='hided_troops_power',event_params.value.int_value,null) as hide_troop__hided_troops_power,
...
if (event_name='intelligence_stamina' and event_params.key='change',event_params.value.int_value,null) as intelligence_stamina__change,
...
if (event_name='wounded_reward' and event_params.key='lost_power',event_params.value.int_value,null) as wounded_reward__lost_power,
...
if (event_name='faq1.0',1,0) as faq1.0__count,
...
if (event_name='micro_com1.1',1,0) as micro_com1.1__count,
...
if (event_name='session_en㚈',1,0) as session_en㚈__count,
...
max(login_music_state__flag) as login_music_state__flag, 
max(track_auth__count) as track_auth__count, 
max(wd_daryl_unlock_new_buildings__count) as wd_daryl_unlock_new_buildings__count, 
max(intel_v2__count) as intel_v2__count, 
max(daily_reward__count) as daily_reward__count, 
max(gold_event__count) as gold_event__count, 
max(se_battle__count) as se_battle__count, 
max(gather__count) as gather__count, 
max(custom_iap__count) as custom_iap__count, 
max(login_lord_gem__count) as login_lord_gem__count, 
max(month_card__count) as month_card__count, 
max(building_upgrade__count) as building_upgrade__count, 
max(CMS__count) as CMS__count, 
max(Halloween_Candy__count) as Halloween_Candy__count, 
max(lord_gem_verification_not_received__count) as lord_gem_verification_not_received__count, 
max(alliance_craft__count) as alliance_craft__count, 
max(score_special__count) as score_special__count, 
max(scout__count) as scout__count, 
max(teleport__count) as teleport__count, 
max(recharge_rebate__count) as recharge_rebate__count, 
max(gameLike__count) as gameLike__count, 
max(advance_research_upgrade__count) as advance_research_upgrade__count, 
max(festival_daily_task__count) as festival_daily_task__count, 
max(change_equipment__count) as change_equipment__count, 
max(ab_test__count) as ab_test__count, 
max(kingdom_war_pve__count) as kingdom_war_pve__count, 
max(wd_user_get_quest_reward__count) as wd_user_get_quest_reward__count, 
max(activity_festival_seven_days__count) as activity_festival_seven_days__count, 
max(iap_charge_continuous__count) as iap_charge_continuous__count, 
max(activity_plasma_scientific_prepare__count) as activity_plasma_scientific_prepare__count, 
max(questionnaire__count) as questionnaire__count, 
max(zombie_boss__count) as zombie_boss__count, 
max(remote_config__count) as remote_config__count, 
max(alliance_shop__count) as alliance_shop__count, 
max(Stroy_Collect_Complete__flag) as Stroy_Collect_Complete__flag, 
max(today_first_login__count) as today_first_login__count, 
max(activity_wd_seek__count) as activity_wd_seek__count, 
max(honor_pass_2__count) as honor_pass_2__count, 
max(train_troop_finish__count) as train_troop_finish__count, 
max(live_streaming__count) as live_streaming__count, 
max(timer_chest_gain__count) as timer_chest_gain__count, 
max(gold_event_season__count) as gold_event_season__count, 
max(building_upgrade_finish__count) as building_upgrade_finish__count, 
max(quest_complete__count) as quest_complete__count, 
max(chapter_quest_complete__count) as chapter_quest_complete__count, 
max(upgrade_clue__count) as upgrade_clue__count, 
max(dialog__count) as dialog__count, 
max(leave_alliance__count) as leave_alliance__count, 
max(survivor_support__count) as survivor_support__count, 
max(lord_level_up__count) as lord_level_up__count, 
max(localization_signin__count) as localization_signin__count, 
max(analysis_center_war__count) as analysis_center_war__count, 
max(go_back_claim_login_reward__count) as go_back_claim_login_reward__count, 
max(go_back_claim_free_iap__count) as go_back_claim_free_iap__count, 
max(halloween_event__count) as halloween_event__count, 
max(battle__count) as battle__count, 
max(disband_alliance__count) as disband_alliance__count, 
max(gain_reward__count) as gain_reward__count, 
max(combat__count) as combat__count, 
max(alliance_help__count) as alliance_help__count, 
max(vip__count) as vip__count, 
max(research_finish__count) as research_finish__count, 
max(login_lord_equipment__count) as login_lord_equipment__count, 
max(alliance_iap_gift__count) as alliance_iap_gift__count, 
max(buff_change__count) as buff_change__count, 
max(research_quest_complete__count) as research_quest_complete__count, 
max(battle_gather__count) as battle_gather__count, 
max(talent_skill__count) as talent_skill__count, 
max(chapter_group_start__count) as chapter_group_start__count, 
max(hidden_exploration__count) as hidden_exploration__count, 
max(battle_monster__count) as battle_monster__count, 
max(join_alliance__count) as join_alliance__count, 
max(world_line__count) as world_line__count, 
max(localization_exchange_event__count) as localization_exchange_event__count, 
max(prosperity__count) as prosperity__count, 
max(festival_region_pass__count) as festival_region_pass__count, 
max(alliance_tech__count) as alliance_tech__count, 
max(chapter_group_complete__count) as chapter_group_complete__count, 
max(go_back_sprint_quest_complete__count) as go_back_sprint_quest_complete__count, 
max(activity_advance_research_five_days__count) as activity_advance_research_five_days__count, 
max(alliance_request__count) as alliance_request__count, 
max(alliance_mark__count) as alliance_mark__count, 
max(explore_loading__count) as explore_loading__count, 
max(dress_up__count) as dress_up__count, 
max(exchange_code__count) as exchange_code__count, 
max(dismiss_troop__count) as dismiss_troop__count, 
max(go_back__count) as go_back__count, 
max(fresher_pease_shield__count) as fresher_pease_shield__count, 
max(user_agreement__count) as user_agreement__count, 
max(world_event_season_sign__count) as world_event_season_sign__count, 
max(week_card__count) as week_card__count, 
max(activity_survivor_seven_days__count) as activity_survivor_seven_days__count, 
max(supplememt_tropps_base__count) as supplememt_tropps_base__count, 
max(activity_red_packet__count) as activity_red_packet__count, 
max(battle_power_change__change_power) as battle_power_change__change_power, 
max(wd_daryl_get_reward__count) as wd_daryl_get_reward__count, 
max(avaleague_quest__count) as avaleague_quest__count, 
max(city_buff__count) as city_buff__count, 
max(big_timer_chest__count) as big_timer_chest__count, 
max(survivor_unlock__count) as survivor_unlock__count, 
max(custom_iap_2__count) as custom_iap_2__count, 
max(hero_drop__count) as hero_drop__count, 
max(tutorial_ex__count) as tutorial_ex__count, 
max(unlock_city_block_v3__count) as unlock_city_block_v3__count, 
max(exchange_survivor_chip__count) as exchange_survivor_chip__count, 
max(kingdom_war__count) as kingdom_war__count, 
max(plasma_building_prepare__count) as plasma_building_prepare__count, 
max(gameStoreScore__count) as gameStoreScore__count, 
max(growth_fund__count) as growth_fund__count, 
max(kvk__count) as kvk__count, 
max(wd_user_draw_real_reward__count) as wd_user_draw_real_reward__count, 
max(kvk_recuperate__count) as kvk_recuperate__count, 
max(heal_troop__flag) as heal_troop__flag, 
max(donate__tot_times) as donate__tot_times, 
max(ask_alliance_help__count) as ask_alliance_help__count, 
max(view_other_city__count) as view_other_city__count, 
max(alliance_boss__count) as alliance_boss__count, 
max(survivor_search__count) as survivor_search__count, 
max(reward_center__count) as reward_center__count, 
max(alliance_donate_rank__count) as alliance_donate_rank__count, 
max(survivor__count) as survivor__count, 
max(user_vault__count) as user_vault__count, 
max(poison_land__count) as poison_land__count, 
max(battle_pvp_detail__count) as battle_pvp_detail__count, 
max(seven_day__count) as seven_day__count, 
max(chapter_quest_gain_quest_reward__count) as chapter_quest_gain_quest_reward__count, 
max(zombie_invasion__count) as zombie_invasion__count, 
max(exploration__count) as exploration__count, 
max(lord_equipment_gem_power__change_power) as lord_equipment_gem_power__change_power, 
max(IapPaymentSuccess__count) as IapPaymentSuccess__count, 
max(survivor_camp__count) as survivor_camp__count, 
max(hide_troop__hided_troops_power) as hide_troop__hided_troops_power, 
max(europe_policy__count) as europe_policy__count, 
max(micro_com__count) as micro_com__count, 
max(activity_daily_iap_accumulative_reward__count) as activity_daily_iap_accumulative_reward__count, 
max(halloween_candy__count) as halloween_candy__count, 
max(powerup__count) as powerup__count, 
max(roguelike__count) as roguelike__count, 
max(claim_sprint_box_reward__count) as claim_sprint_box_reward__count, 
max(go_back_new_world__count) as go_back_new_world__count, 
max(unlock_city_block__count) as unlock_city_block__count, 
max(supplememt_tropps__count) as supplememt_tropps__count, 
max(loading__count) as loading__count, 
max(city_decoration__count) as city_decoration__count, 
max(stamina__count) as stamina__count, 
max(big_turntable__count) as big_turntable__count, 
max(wd_daryl_new_clue_gained__count) as wd_daryl_new_clue_gained__count, 
max(train_troop__count) as train_troop__count, 
max(story__count) as story__count, 
max(research_upgrade__flag) as research_upgrade__flag, 
max(alliance_speedup__count) as alliance_speedup__count, 
max(custom_iap_3__count) as custom_iap_3__count, 
max(shop__count) as shop__count, 
max(login__count) as login__count, 
max(cheat_user__flag) as cheat_user__flag, 
max(kingdom_event__count) as kingdom_event__count, 
max(world_event__count) as world_event__count, 
max(quest_gain_reward__count) as quest_gain_reward__count, 
max(payment_submit_order__count) as payment_submit_order__count, 
max(chapter_quest_gain_group_reward__count) as chapter_quest_gain_group_reward__count, 
max(survivor_will__count) as survivor_will__count, 
max(forge_equipment__count) as forge_equipment__count, 
max(alliance_zone__count) as alliance_zone__count, 
max(survivor_summon__count) as survivor_summon__count, 
max(city_fire__flag) as city_fire__flag, 
max(buy_month_card__count) as buy_month_card__count, 
max(survivor_link__count) as survivor_link__count, 
max(create_alliance__count) as create_alliance__count, 
max(iap_exchange__count) as iap_exchange__count, 
max(super_exchange__count) as super_exchange__count, 
max(charge_first_pass__count) as charge_first_pass__count, 
max(switch_kingdom__count) as switch_kingdom__count, 
max(activity_gift__count) as activity_gift__count, 
max(tutorial__count) as tutorial__count, 
max(survivor_equipment__count) as survivor_equipment__count, 
max(npc_store__count) as npc_store__count, 
max(wd_user_answer_question__count) as wd_user_answer_question__count, 
max(alliance_mobilization__count) as alliance_mobilization__count, 
max(intelligence_stamina__change) as intelligence_stamina__change, 
max(dynamic_recommend_iap__count) as dynamic_recommend_iap__count, 
max(upgrade_troop__count) as upgrade_troop__count, 
max(MarchLine_Click__count) as MarchLine_Click__count, 
max(login_survivor_equipment__flag) as login_survivor_equipment__flag, 
max(c__count) as c__count, 
max(fallen_knight__count) as fallen_knight__count, 
max(fallen_knight_defend_success__count) as fallen_knight_defend_success__count, 
max(battle_gve__count) as battle_gve__count, 
max(user_gem__count) as user_gem__count, 
max(puzzle_pve__count) as puzzle_pve__count, 
max(lord_equipment_power__count) as lord_equipment_power__count, 
max(hunter_house__count) as hunter_house__count, 
max(cultivate__count) as cultivate__count, 
max(plasma_cannon__count) as plasma_cannon__count, 
max(go_back_claim_sprint_quest_reward__count) as go_back_claim_sprint_quest_reward__count, 
max(storyline__count) as storyline__count, 
max(iap_trigger__count) as iap_trigger__count, 
max(wounded_reward__lost_power) as wounded_reward__lost_power, 
max(advance_research_finish__count) as advance_research_finish__count, 
max(go_back_user_info__count) as go_back_user_info__count, 
max(festival_pass__count) as festival_pass__count, 
max(wd_daryl_clue_compose__count) as wd_daryl_clue_compose__count, 
max(payment_pay_type__count) as payment_pay_type__count, 
max(user_skill__count) as user_skill__count, 
max(walking_dead_event__count) as walking_dead_event__count, 
max(mini_wonder_war__count) as mini_wonder_war__count, 
max(faq1.0__count) as faq1.0__count, 
max(buy_week_card__count) as buy_week_card__count, 
max(stronghold_level_reward__count) as stronghold_level_reward__count, 
max(world_event_memorial_book_abyss__count) as world_event_memorial_book_abyss__count, 
max(festival_wish__count) as festival_wish__count, 
max(festival_collection__count) as festival_collection__count, 
max(focus_out__flag) as focus_out__flag, 
max(MonthCard__count) as MonthCard__count, 
max(focus_in__flag) as focus_in__flag, 
max(activity_limit_time_discount_shop__count) as activity_limit_time_discount_shop__count, 
max(micro_com1.1__count) as micro_com1.1__count, 
max(go_back_claim_sprint_task_reward__count) as go_back_claim_sprint_task_reward__count, 
max(march__count) as march__count, 
max(transaction__count) as transaction__count, 
max(festival_boss__count) as festival_boss__count, 
max(wd_collection__count) as wd_collection__count, 
max(avaleague__count) as avaleague__count, 
max(avaleague_guess__count) as avaleague_guess__count, 
max(exchange_gifts__count) as exchange_gifts__count, 
max(auto_fix_date__flag) as auto_fix_date__flag, 
max(festival_navigation__count) as festival_navigation__count, 
max(lord_gem_verification_attack_boss_finish__count) as lord_gem_verification_attack_boss_finish__count, 
max(open_fallen_knight__count) as open_fallen_knight__count, 
max(lord_gem_verification_quest_complete__count) as lord_gem_verification_quest_complete__count, 
max(action__count) as action__count, 
max(anti_addiction__count) as anti_addiction__count, 
max(climbing_tower__count) as climbing_tower__count, 
max(festival_story__count) as festival_story__count, 
max(new_big_turntable__count) as new_big_turntable__count, 
max(festival_zodiac_collect__count) as festival_zodiac_collect__count, 
max(startDailyQuestBI__count) as startDailyQuestBI__count, 
max(lord_gem_verification_attack_boss_start__count) as lord_gem_verification_attack_boss_start__count, 
max(lord_gem_verification_combat_ready_receive__count) as lord_gem_verification_combat_ready_receive__count, 
max(abyss__count) as abyss__count, 
max(honor_pass__count) as honor_pass__count, 
max(hero_flip_card_over__count) as hero_flip_card_over__count, 
max(launch_start__flag) as launch_start__flag, 
max(lord_gem_verification_quest_receive__count) as lord_gem_verification_quest_receive__count, 
max(activity_festival_equip_seven_days__count) as activity_festival_equip_seven_days__count, 
max(lord_gem_verification_rank__count) as lord_gem_verification_rank__count, 
max(world_open__count) as world_open__count, 
max(season_climb_tower__count) as season_climb_tower__count, 
max(treasure_discover__count) as treasure_discover__count, 
max(noteBookWithoutAlliance__count) as noteBookWithoutAlliance__count, 
max(throne_shock_relocation__count) as throne_shock_relocation__count, 
max(lord_gem_verification_buff_change__count) as lord_gem_verification_buff_change__count, 
max(friend_list_option__count) as friend_list_option__count, 
max(festival_pass_2__count) as festival_pass_2__count, 
max(submitDailyQuestBI__count) as submitDailyQuestBI__count, 
max(exchange_event__count) as exchange_event__count, 
max(invite_new_user__count) as invite_new_user__count, 
max(start_gather_march__count) as start_gather_march__count, 
max(activity_recycle__count) as activity_recycle__count, 
max(achievement__count) as achievement__count, 
max(session_start__count) as session_start__count, 
max(dialog_skip__count) as dialog_skip__count, 
max(lord_gem_verification_ready_open__count) as lord_gem_verification_ready_open__count, 
max(lord_gem_verification_score_quest_complete__count) as lord_gem_verification_score_quest_complete__count, 
max(world_event_memorial_book_kvk__count) as world_event_memorial_book_kvk__count, 
max(equipment_signin__count) as equipment_signin__count, 
max(daily_sign_in__count) as daily_sign_in__count, 
max(ava__count) as ava__count, 
max(session_en㚈__count) as session_en㚈__count, 
max(super_exchange_2__count) as super_exchange_2__count, 
max(wd_lottery__count) as wd_lottery__count, 
max(service_monitoring__count) as service_monitoring__count, 
max(alliance_trade__count) as alliance_trade__count, 
max(activity_drop__count) as activity_drop__count, 
max(session_end__count) as session_end__count, 
max(lord_gem_verification_ready_score_change__count) as lord_gem_verification_ready_score_change__count, 
max(event_SS_Revenue__value_in_usd) as event_SS_Revenue__value_in_usd, 
max(first_open__flag) as first_open__flag,
from data_flat_1
...
ifnull(sum(case when event_name = 'faq1.0' then faq1.0__count end),0) as faq1.0__count,
...
ifnull(sum(case when event_name = 'micro_com1.1' then micro_com1.1__count end),0) as micro_com1.1__count,
...
ifnull(sum(case when event_name = 'session_en㚈' then session_en㚈__count end),0) as session_en㚈__count,
...
ifnull(b.faq1.0__count,0) as faq1.0__count,
...
ifnull(b.micro_com1.1__count,0) as micro_com1.1__count,
...
ifnull(b.session_en㚈__count,0) as session_en㚈__count,
