...
array_agg(src order by universal_user_id,user_id,install_date,event_date desc limit 1)[offset(0)].* except(universal_user_id,user_id,install_date,event_date) 
